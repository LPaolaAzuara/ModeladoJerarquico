/*Laura Paola Azuara López
* Práctica 4, Modelado jerarquico 
* Fecha de entrega: 6 de septiebre del 2024
*/
#include<iostream>
#include <GL/glew.h>
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico  Paola Azuara", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//DedoA1
		model = glm::translate(modelTemp, glm::vec3(1.5f, 0.35f, 0.375f));
		...
		//DedoB1
		model = glm::translate(modelTemp, glm::vec3(0.0f, 0.0f, -0.35f));
		...
		//DedoC1
		model = glm::translate(modelTemp, glm::vec3(0.0f, 0.0f, -0.5f));
		...
		//DedoD1
		model = glm::translate(modelTemp, glm::vec3(0.f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(dedo7), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		...
		model = model = glm::translate(model, glm::vec3(0.5f, 0.5f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = model = glm::translate(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//DedoD2
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo8), glm::vec3(0.0f, 1.0f, 0.0f));
		model = model = glm::translate(model, glm::vec3(0.5f, 0.5f,0.9f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
